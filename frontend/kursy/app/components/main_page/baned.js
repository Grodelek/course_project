...
export default function Banned() {
    ...
    useEffect(() => {
          if (typeof window !== "undefined") {
            setDateStart(localStorage.getItem("banStart") || "");
            setDateEnd(localStorage.getItem("banEnd") || "");
            setReason(localStorage.getItem("banReason") || "");
    ...
    return (
        <section className="flex w-full h-screen">
          <div className="w-full md:w-1/2 bg-gray-900 text-white flex flex-col justify-center p-8">
            ...
            <p className="text-lg text-red-100 leading-relaxed">
                ...
                <br />
                w okresie od{" "}
                <span className="text-white font-medium">{dateStart}</span> do{" "}
                <span className="text-white font-medium">{dateEnd}</span>.
            </p>
        ...
        <button className="mt-6 bg-red-600 hover:bg-red-700 px-6 py-2 rounded-lg font-semibold transition w-full shadow-sm" onClick={handleSubmit}>
